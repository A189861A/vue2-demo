<template>
    <div class="container">
      <div class="top">
        <KooHomeTop></KooHomeTop>
      </div>
      <div class="borrow">
        <KooHomeBorrow></KooHomeBorrow>
      </div>
      <div class="increase">
        <KooHomeIncrease></KooHomeIncrease>
      </div>
      <div class="guide">
        <KooHomeGuide></KooHomeGuide>
      </div>
      <div class="aboutus">
        <KooHomeAbout></KooHomeAbout>
      </div>
    </div>
...
<script>
import KooHomeTop from '@/koo/Top.vue'
import KooHomeBorrow from '@/koo/Borrow.vue'
import KooHomeIncrease from '@/koo/Increase.vue'
import KooHomeGuide from '@/koo/Guide.vue'
import KooHomeAbout from '@/koo/AboutUs.vue'
export default {
  name: 'KooHome',
  data() {
    return {
